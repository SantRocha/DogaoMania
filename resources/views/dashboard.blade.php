            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4 dark:text-gray-50">Pão, carne, queijo, alface e molho especial</p>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4 dark:text-gray-50">Pão, carne, queijo, bacon crocante e molho barbecue</p>
                        <div class="flex justify-between items-center">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4 dark:text-gray-50">Pão, hambúrguer de grão-de-bico, queijo e vegetais frescos</p>
                        <div class="flex justify-between items-center">
